// components/section/ExperienceSection.tsx
'use client';
            ...
            <div className="flex md:flex-col overflow-x-auto md:overflow-x-visible scrollbar-hide">
              {experienceData.map((exp, index) => (
                <button
                  ...
                  className={`py-3 px-4 text-left border-b-2 md:border-b-0 md:border-l-2 transition-all whitespace-nowrap md:whitespace-normal flex items-center ${
                    activeTab === index
